...
interface ReceiptSingleProps {
    ...
    receipt: string;
    senderName: string;
    senderIwaletID: string;
    receiverName: string;
    receiverIwaletID: string;
}

const ReceiptSingle: React.FC<ReceiptSingleProps> = ({
    LogoSrc,
    transactionCode,
    receipt,
    senderName,
    ...
    return (
    <div className="text-black p-4 rounded mt-4">
        <div className="flex h-screen w-full items-center justify-center">
            <div className="w-80 rounded bg-gray-50 px-6 pt-8 shadow-2xl shadow-[0px_4px_16px_rgba(29,185,84,0.1),_0px_8px_24px_rgba(29,185,84,0.1),_0px_16px_56px_rgba(29,185,84,0.1)]">
                <img src={LogoSrc} alt="iWalet LogoSrc" className="mx-auto w-16 py-2" />
